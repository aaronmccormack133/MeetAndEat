...
public class restaurantFinder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeNameText = (TextView) findViewById(R.id.getRestPlace);
        placeAddressText = (TextView) findViewById(R.id.getRestAdd);
        attributionText = (WebView) findViewById(R.id.attrText);
        getPlaceButton = (Button) findViewById(R.id.getRestBtn);
        ...
        getPlaceButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                try {
                    Intent intent = builder.build(restaurantFinder.this);
        ...
        if(ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                requestPermissions(new String[]
                        {android.Manifest.permission.ACCESS_FINE_LOCATION}, MY_PERMISSION_FINE_LOCATION);
            }
        }
    }
